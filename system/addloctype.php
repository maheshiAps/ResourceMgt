...
<?php include 'dbcon.php';
 ...
 ?> 
                  <div class="card-body">
                    <form class="form-horizontal" action="" method="post">
                      ...
                      <div class="form-group row">
                        <div class="col-4">
                          <lable>
                          <input class="form-control" type="text" placeholder="" name="locnm" required></lable>
      ...
      if(isset($_POST['submit'])){
        ...
        $insert=mysqli_query($con,"INSERT INTO locationtype(LocationType) VALUES('$locnm')");//database connection opened
  ...
  while($row=mysqli_fetch_array($request)){
        ...
        ?>
                  <tr>
                    ...
                    <td><a href="editloctype.php?id=<?php echo $id; ?>" class="btn btn-success btn-sm fa fa-edit">Edit</a></td>
